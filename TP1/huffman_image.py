...
class Image:
    def __init__(self):
        ...
        # Dictionary with key as freqs and values as Probabilities
        self.prob_dict = {}
...
# Creating a dict of probabilities , with keys are intensities and value as probabilities
...
# Creating UPTREE
    def upTree(self):
        ...
        # Sorting all Nodes in workspace to create up-tree
        ...
        while(1):
            ...
            # Creating A new node from  two smallest probability intensities
...
# Creating Down Tree ie assigning words to Leaf Nodes from Root
    ...
    def sendBinaryData(self, path):
        #  Our self.encodedString is just list of strings with characters char('0') & char('1')
        ...
        # To do the above work we are using bit-string from BitArray library
    ...
    def decode(self, path):
        ...
        # For reading binary from file we are using bit-array library (this is different one from above used BitArray)
